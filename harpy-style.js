...
<nav class="header"><div class="nav-content"><div class="xtitle"><a href="${root}index.html">harpy</a></div>   <a href="${root}art.html">ART</a>   <a href="${root}14days.md.html">STORIES</a>   <a href="${root}archive.html">ARCHIVE</a></div></nav>
`);
